# Grappling Games Project

This document provides instructions for Claude to follow when generating or modifying markdown files for the Grappling Games project. These guidelines ensure consistent structure and formatting across all class and game files.

## Curriculum Reference

The class curriculum schedule is tracked externally in `C:\Users\lukas\Downloads\Jiu-Jitsu Curriculum_2026.xlsx`. Consult it to determine which techniques/positions a given class date should focus on.
