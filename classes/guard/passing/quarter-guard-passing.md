...
This class builds quarter guard passing from standing entry and single-leg defense into progressive upper-body control, then finishes with side control attacking.
...
**Time:** 3 minutes per role, 1 partner or 6 minutes total - switching back and forth
...
**Win:** Connect your knees and elbows between you and your partner, stand, or reverse the position
...
**Win:** Reguard (any guard position placing legs between), reverse and come on top, or build to turtle with back uncovered

## Conclusion

Finish with live goes from quarter guard or side control and emphasize smooth transitions between control, passing, and submission threats.
