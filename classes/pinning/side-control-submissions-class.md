# Side Control Submissions Class
**Class Length:** 1 hour

This class develops pathways from standing control into side control, builds fundamental frame management and flattening mechanics, then progresses through specific submission setups from side control to mount control with finishing mechanics. The progression emphasizes maintaining control while hunting for submissions.
...
- Pinning & Submissions: 24 minutes  
	- Side Control Head and Arm Attacks: 6 minutes (2 x 3-minute rounds)  
	- Side Control Figure Four Attack: 6 minutes (2 x 3-minute rounds)  
	- Mount Wrist Control to Submission: 6 minutes (2 x 3-minute rounds)  
	- Side Control Framing to Submission: 6 minutes (2 x 3-minute rounds)  
...
**Objective:** Maintain wrist control and work to submit the bottom player from any dominant position while staying out of their guard  
**Win:** Successfully submit the bottom player with any submission while maintaining a dominant position (mount, side control, knee on belly, back control, etc.)
...
#### Top Player
**Position:** On top, in front of your partner's legs hugging their hips  
**Objective:** Break the bottom player's frames, establish control, and work to submit from any dominant position (side control, mount, knee on belly, back control, etc.) while staying out of their guard  
**Win:** Successfully submit the bottom player with any submission while maintaining a dominant position (side control, mount, knee on belly, back control, etc.)

#### Bottom Player
**Position:** On your side, framing at the shoulder and wrist  
**Objective:** Maintain frames to prevent control, then work to escape and recover guard or reverse position  
**Win:** Get your legs back in between you and your partner with at least one of the top player's legs controlled above the knee, or successfully get on top

## Conclusion

Finish class with Q&A and some live rolling starting from side control position. Focus on applying the frame management and submission setup techniques learned during class, as well as practicing the transitions from side control to mount when hunting for submissions. Bottom players should practice early defensive frame maintenance and guard recovery methods learned in the drills.
