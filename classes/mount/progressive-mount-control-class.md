# Progressive Mount Control Class
**Class Length:** 1 hour

This class focuses on establishing dominant positioning through standing control, guard passing, and mount attacks. Students will progress through control battles, guard passing scenarios, and mount submissions using progressive drilling methods.
...
- Standing Drills: 12 minutes
  - Head Position to Neck Trap vs Underhook: 6 minutes (2 x 3-minute rounds)
  - Locked Hands Control Battle: 6 minutes (2 x 3-minute rounds)
- Guard Drills: 12 minutes
  - Progressive Guard Passing: 12 minutes (2 x 6-minute rounds)
- Pinning Drills: 12 minutes
  - Progressive Mount Wrist Control to Isolation: 6 minutes (2 x 3-minute rounds)
...
**Objective:** Connect your head to the side of your partner's neck and hold that position  
...
#### Attacking Player
**Position:** Starting Position 1: Mounted on top with 1 wrist pinned to the ground  
**Objective:** Get under both arms and isolate them bicep to ear  
**Win:** Successfully isolate both arms bicep to ear for 3 seconds

**Starting Positions:**
- Position 1: Mount with 1 wrist pinned to the ground
- Position 2: Mount with wrist grips on chest
- Position 3: Side control

#### Defending Player
**Position:** Starting Position 1: On back with partner mounted on top, one wrist pinned to the ground  
...
**Win:** Armbar position secured OR arm triangle position secured (finish if agreed)
...
**Allowed Submissions:**
- Armbar (from any position)
- Arm triangle (from any position)

#### Defending Player
**Position:** Starting Position 1: On back with partner mounted on top, one wrist pinned to the ground  
**Objective:** Get both your knees and hands in front of your opponent  
**Win:** Both knees and both hands positioned in front of opponent (defensive frames with leg control) or successfully escape to top position

## Conclusion
Finish class with Q&A and some live rolling starting from mount or guard positions. Focus on applying the wrist control and submission setups learned during class, as well as practicing the progressive position advancement when opportunities arise.
